                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up="" href="{{ route('frontend.game.list.category', $v) }}">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--{{$v}}" alt="{{$v}}" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/{{$v}}.svg">
                                        </span>
                            ...
                            @if ($categories && count($categories))
                                ...
                                <li class="providers__dropdown-item ng-scope">
                                    <a class="providers__link" href="{{ route('frontend.game.list.category', $category->href) }}">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/{{$category->href}}.svg">
                                        </span>
