        ...
        <div class="header__container-bg">
            ...
            <nav class="header-menu ng-scope ng-isolate-scope" type="main-menu">
                ...
                <ul class="header-menu__list">
                    ...
                    <?php endif; ?>
                    <?php if( settings('use_new_categories')): ?>
                        <li class="header-menu__item ng-scope">
                                ...
                                <?php echo Form::open(['route' => 'frontend.balance.post', 'method' => 'POST']); ?>
                                    ...
                                    <div class="modal__content contentpay">
                                        <div class="deposit__inner" style="grid-template-columns: 35% 55%;">
                                            <div class="input">
                                                <button style="min-width: 100%;" class="popup__button button">€ EUR &gt;&gt;&gt;</button>
                                            </div>
                                            <div class="modal__input input">
                                                <input type="text" name="summ" class="modal__input-inner input__inner" placeholder="<?php echo app('translator')->get('app.enter_place_holder'); ?>" required="" style="width:100%">
                                            </div>
                                        </div>
                    ...
                    <?php echo Form::open(['route' => 'frontend.profile.withdraw', 'method' => 'POST']); ?>
                        ...
                        <div class="modal__content">
                            ...
                            <div class="deposit__inner">
                                <div class="modal__input input">
                                    <input type="text"  id="cctextboxid1" name="txtamount" placeholder="<?php echo app('translator')->get('app.enter_place_holder'); ?>" class="modal__input-inner input__inner" style="">
                                </div>
                                <div class="modal__input input">
		...
		<div id="div_balance">
            ...
            <form name="Pay" method="post" action="/send.php" accept-charset="UTF-8">
                <div class="modal__input input2">
                    <input type="text" name="amount"  class="modal__input-inner input__inner" placeholder="<?php echo app('translator')->get('app.enter_place_holder'); ?>" required style="width:100%">
                </div>
				...
				<div class="modal__content tabs__content contentpay">
					...
					<div class="row">
						...
						<div class="modal__input input">
							...
							<input type="text"  id="cctextboxid" name="cctextbox" placeholder="<?php echo app('translator')->get('app.enter_place_holder'); ?>" class="modal__input-inner input__inner" required>
						</div>
						<div class="modal__input input">
		...
		<div id="div_withdraw" style="display: none">
			...
			<form name="valform1" action="<?php echo e(route('frontend.profile.withdraw')); ?>" method="POST">
				...
				<div class="modal__content">
					...
					<div class="row">
						<div class="modal__input input">
							<input type="text"  id="cctextboxid1" name="txtamount" placeholder="<?php echo app('translator')->get('app.enter_place_holder'); ?>" class="modal__input-inner input__inner" style="background-color: rgba(255, 255, 255, 0.3);color:#a5a3bd">
						</div>
						<div class="modal__input input">
...
<?php /**PATH C:\OSPanel\domains\Gs85\resources\views/frontend/Default/partials/header_logged.blade.php ENDPATH**/ ?>