            ...
            <div id="logs">
                ...
                <?php endif; ?>
                            ...
                            <div class="col-sm-4 b-r b-b">
                                <div class="el-tablo centered el-tabloPiso">
                                    <div class="value text-success statsTop top_in"><?php echo e($total_in); ?></div>
                                    <div class="label">In</div>
                                </div>
                            </div>
                            <div class="col-sm-4 b-r b-b">
                                <div class="el-tablo centered el-tabloPiso">
                                    <div class="value text-danger statsTop top_out"><?php echo e($total_out); ?></div>
                                    <div class="label">Out</div>
                                </div>
                            </div>
                            <div class="col-sm-4 b-r b-b">
                                <div class="el-tablo centered el-tabloPiso">
                                    <div class="value text-primary statsTop top_total"><?php echo e($total_in - $total_out); ?></div>
                ...
                <div class="logs_2" style="padding-top: 15px;">
                    ...
                    <?php $__currentLoopData = $newStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('backend.newbackend.stats.row', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('backend.newBackend.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\resources\views/backend/newbackend/shop/index.blade.php ENDPATH**/ ?>