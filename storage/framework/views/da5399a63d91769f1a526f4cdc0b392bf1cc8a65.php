<div class="modal fade cusModel success" id="addCredit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content text-center">
            ...
            <form action="<?php echo e(url('backend/terminal/balance/add')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\OSPanel\domains\localhost\resources\views/backend/terminal/modals/add_credit.blade.php ENDPATH**/ ?>