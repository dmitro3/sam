                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up="" href="<?php echo e(route('frontend.game.list.category', $v)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--<?php echo e($v); ?>" alt="<?php echo e($v); ?>" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/<?php echo e($v); ?>.svg">
                                        </span>
                            ...
                            <?php if($categories && count($categories)): ?>
                                ...
                                <li class="providers__dropdown-item ng-scope">
                                    <a class="providers__link" href="<?php echo e(route('frontend.game.list.category', $category->href)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/<?php echo e($category->href); ?>.svg">
                                        </span>
...
<?php echo $__env->make('frontend.Default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\Gs85\resources\views/frontend/Default/games/list.blade.php ENDPATH**/ ?>