    ...
    class Server
    {
        ...
        {/*
            ...
            if( $umid == '40186' ) 
            {
                ...
                $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $slotSettings->GetGameData('JacksOrBetterPTTotalWin');
                ...
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand($slotSettings->GetGameData('JacksOrBetterPTDCard'), 12);
                }
                else
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand(0, $slotSettings->GetGameData('JacksOrBetterPTDCard'));
                }
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = [
                    $cardsArr[0], 
                    $cardsArr[1], 
                ...
                if( $slotSettings->GetGameData('JacksOrBetterPTDCard') == $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                    $totalWin = $_obf_0D37111B3335140203262E17350902171D182F5B312522;
                }
                else if( $slotSettings->GetGameData('JacksOrBetterPTDCard') < $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                ...
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterPTDAmount') . ',"cWin":' . $_obf_0D37111B3335140203262E17350902171D182F5B312522 . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterPTDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40182' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTDAmount', (double)$_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['amount']);
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterPTDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            }
            if( $umid == '40179' ) 
            {
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = $slotSettings->GetGameData('JacksOrBetterPTCurrentCards');
                $cardsArr = $slotSettings->GetGameData('JacksOrBetterPTCards');
                $_obf_0D0B2C1A1303340B2C0E25400D1E23015C0637363D2411 = 0;
                $_obf_0D0421331D082B13400825132F2C0C0326212537284011 = $slotSettings->GetGameData('JacksOrBetterPTBankReserved');
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $totalWin = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 * $slotSettings->GetGameData('JacksOrBetterPTBet');
                    if( $totalWin <= $bank ) 
                    {
                        break;
                    }
                ...
                $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"idle","slotLines":1,"slotBet":' . $slotSettings->GetGameData('JacksOrBetterPTBet') . ',"totalFreeGames":0,"currentFreeGames":0,"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":0,"totalWin":' . $totalWin . ',"winLines":[],"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . '}}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40175' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTCurrentCards', $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01);
