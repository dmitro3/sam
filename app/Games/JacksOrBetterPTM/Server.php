    ...
    class Server
    {
        ...
        {/*
            ...
            if( $umid == '40186' ) 
            {
                ...
                $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $slotSettings->GetGameData('JacksOrBetterPTMTotalWin');
                ...
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand($slotSettings->GetGameData('JacksOrBetterPTMDCard'), 12);
                }
                else
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand(0, $slotSettings->GetGameData('JacksOrBetterPTMDCard'));
                }
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = [
                    $cardsArr[0], 
                    $cardsArr[1], 
                ...
                if( $slotSettings->GetGameData('JacksOrBetterPTMDCard') == $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                    $totalWin = $_obf_0D37111B3335140203262E17350902171D182F5B312522;
                }
                else if( $slotSettings->GetGameData('JacksOrBetterPTMDCard') < $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                ...
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterPTMDAmount') . ',"cWin":' . $_obf_0D37111B3335140203262E17350902171D182F5B312522 . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterPTMDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40182' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTMDAmount', (double)$_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['amount']);
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterPTMDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            }
            if( $umid == '40179' ) 
            {
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = $slotSettings->GetGameData('JacksOrBetterPTMCurrentCards');
                $cardsArr = $slotSettings->GetGameData('JacksOrBetterPTMCards');
                $_obf_0D0B2C1A1303340B2C0E25400D1E23015C0637363D2411 = 0;
                $_obf_0D0421331D082B13400825132F2C0C0326212537284011 = $slotSettings->GetGameData('JacksOrBetterPTMBankReserved');
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    $totalWin = $_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 * $slotSettings->GetGameData('JacksOrBetterPTMBet');
                    if( $totalWin <= $bank ) 
                    {
                        break;
                    }
                ...
                $slotSettings->SetGameData('JacksOrBetterPTMTotalWin', $totalWin);
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"totalWin":' . $totalWin . ',"data":{"cards":[{"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . '}],"windowId":"OxupG1"},"ID":40180,"umid":53}';
                $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"idle","slotLines":1,"slotBet":' . $slotSettings->GetGameData('JacksOrBetterPTMBet') . ',"totalFreeGames":0,"currentFreeGames":0,"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":0,"totalWin":' . $totalWin . ',"winLines":[],"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . '}}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            ...
            if( $umid == '40175' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterPTMCurrentCards', $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01);
                ...
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
                $response = '{"responseEvent":"spin","responseType":"bet","serverResponse":{"cardsArr":' . json_encode($cardsArr) . ',"state":"draw","slotLines":1,"slotBet":' . $allbet . ',"totalFreeGames":0,"currentFreeGames":0,"Balance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"afterBalance":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"bonusWin":0,"totalWin":' . $totalWin . ',"winLines":[],"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . '}}';
            ...
            switch( $umid ) 
            {
                ...
                case '40024':
                    ...
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"po","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $_obf_0D131333153E3B3F113536290D1D1A025B0D3F16341932) . ']},"ID":40025,"umid":19}';
                    break;
                case '40036':
                ...
                case '40050':
                    ...
                    if( $lastEvent != 'NULL' && $lastEvent->serverResponse->state == 'draw' ) 
                    {
                        ...
                        $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{},"ID":40031,"umid":18}';
                        $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"type":"MAIN","bet":' . ($lastEvent->serverResponse->slotBet * 100) . ',"numCoins":1,"cards":' . json_encode($lastEvent->serverResponse->cards) . ',"windowId":"ztmjLs"},"ID":49289,"umid":28}';
                    }
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":2,"balanceInCents":0},"ID":40085}';
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":1,"balanceInCents":0},"ID":40085}';
                    $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":0},"ID":40085}';
