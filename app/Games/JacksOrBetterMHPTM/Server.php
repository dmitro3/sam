    ...
    class Server
    {
        ...
        {/*
            ...
            if( $umid == '40186' ) 
            {
                ...
                $_obf_0D37111B3335140203262E17350902171D182F5B312522 = $slotSettings->GetGameData('JacksOrBetterMHPTMTotalWin');
                ...
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand($slotSettings->GetGameData('JacksOrBetterMHPTMDCard'), 12);
                }
                else
                {
                    $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 = rand(0, $slotSettings->GetGameData('JacksOrBetterMHPTMDCard'));
                }
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = [
                    $cardsArr[0], 
                    $cardsArr[1], 
                ...
                if( $slotSettings->GetGameData('JacksOrBetterMHPTMDCard') == $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                    $totalWin = $_obf_0D37111B3335140203262E17350902171D182F5B312522;
                }
                else if( $slotSettings->GetGameData('JacksOrBetterMHPTMDCard') < $_obf_0D1F3122335C1704150C39392E1827342A251B093D3732 ) 
                {
                ...
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"amount":' . $slotSettings->GetGameData('JacksOrBetterMHPTMDAmount') . ',"cWin":' . $_obf_0D37111B3335140203262E17350902171D182F5B312522 . ',"pcard":' . $slotSettings->GetGameData('JacksOrBetterMHPTMDCard') . ',"totalWin":' . $totalWin . ',"data":{"cards":' . json_encode($_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01) . ',"windowId":"VRqbhm"},"ID":40187,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
                if( $totalWin <= 0 ) 
                {
            ...
            if( $umid == '40182' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterMHPTMDAmount', (double)$_obf_0D1027172F0A071202030538280B3D0B12241B16110E22['amount']);
                $_obf_0D1713290429323C0B2B02212E103E165B173416383632 = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"am":' . $slotSettings->GetGameData('JacksOrBetterMHPTMDAmount') . ',"card":{"suit":"' . $cardsArr[0]->suit . '","value":"' . $cardsArr[0]->value . '"},"windowId":"VRqbhm"},"ID":40183,"umid":46}';
                $_obf_0D15240C2724212608283D0C5B1E141D0230162D100201[] = '3:::{"data":{"typeBalance":0,"currency":"' . $slotSettings->slotCurrency . '","balanceInCents":' . $_obf_0D1713290429323C0B2B02212E103E165B173416383632 . ',"deltaBalanceInCents":1},"ID":40085}';
            }
            if( $umid == '40179' ) 
            {
                $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01 = $slotSettings->GetGameData('JacksOrBetterMHPTMCurrentCards');
                $cardsArr = $slotSettings->GetGameData('JacksOrBetterMHPTMCards');
                $_obf_0D0421331D082B13400825132F2C0C0326212537284011 = $slotSettings->GetGameData('JacksOrBetterMHPTMBankReserved');
                ...
                for( $i = 0; $i <= 2000; $i++ ) 
                {
                    ...
                    for( $_obf_0D401E1E131E112535250B3719143E1940152302091122 = 0; $_obf_0D401E1E131E112535250B3719143E1940152302091122 < $_obf_0D104035221D280F101E5C2E31392B1D19082E06381132; $_obf_0D401E1E131E112535250B3719143E1940152302091122++ ) 
                    {
                        ...
                        $totalWin += (($_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 * $slotSettings->GetGameData('JacksOrBetterMHPTMBet')) / $_obf_0D104035221D280F101E5C2E31392B1D19082E06381132);
                        $_obf_0D03092D231325032215111B0E1A2F02130A1D08110B22[] = ($_obf_0D144030072C09300C13273D0B122A320C3B04012D0B32 * $slotSettings->GetGameData('JacksOrBetterMHPTMBet')) / $_obf_0D104035221D280F101E5C2E31392B1D19082E06381132;
                    }
                    if( $totalWin <= $bank ) 
                    {
                        break;
            ...
            if( $umid == '40175' ) 
            {
                ...
                $slotSettings->SetGameData('JacksOrBetterMHPTMCurrentCards', $_obf_0D161A0D1C0B19143C31341F5C163E5B0415320E290A01);
